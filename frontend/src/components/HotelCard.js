          ...
          {hotel.has_comfort_rooms ? (
            <>
              ...
              <div className="grid grid-cols-3 gap-2 text-sm mb-3">
                <div>
                  <span className="text-[#4A4A4A] text-xs">{language === 'de' ? 'Einzelzimmer' : 'Single'}</span>
                  <p className="font-semibold text-[#6B1D2A]">{formatPrice(hotel.single_price)} €</p>
                </div>
                <div>
                  <span className="text-[#4A4A4A] text-xs">{language === 'de' ? 'Doppelzimmer' : 'Double'}</span>
                  <p className="font-semibold text-[#6B1D2A]">{formatPrice(hotel.double_price)} €</p>
                </div>
                {hotel.twin_price && (
                  <div>
                    <span className="text-[#4A4A4A] text-xs">{language === 'de' ? 'Zweibettzimmer' : 'Twin'}</span>
