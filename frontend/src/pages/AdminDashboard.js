          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-amber-800">
                {language === 'de' ? 'Bildverwaltung über GitHub' : 'Image Management via GitHub'}
              </h3>
              <p className="text-amber-700 mt-1">
                {language === 'de' 
                  ? 'Bilder werden als statische Dateien im GitHub Repository verwaltet. Neue Bilder können dort im Ordner /frontend/public/images/hotels/ hinzugefügt werden.'
                  : 'Images are managed as static files in the GitHub repository. New images can be added in the /frontend/public/images/hotels/ folder.'}
              </p>
              <a 
