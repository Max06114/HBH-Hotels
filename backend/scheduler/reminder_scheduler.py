"""
Scheduler for automated payment reminders.
Runs weekly and sends reminders 7 weeks before check-in.
"""
...
def init_scheduler():
    """Initialize and start the scheduler with the reminder job."""
